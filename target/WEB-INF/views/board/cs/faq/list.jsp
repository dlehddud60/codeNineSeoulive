...
<head>
    ...
    <script src="../../../../resources/static/js/faq.js"></script>
    ...
    <script>
        $(function(){
            ...
            $('.paging_box li a').click(function(e){
                let selectedPageNum = e.currentTarget.textContent;
                location.href="/board/cs/faq/list?currPage=" + selectedPageNum;
            });
            ...
            function searchByCategory(category, page) {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        console.log(result);
                        var cateData = $('.topic_wrap').html(result).find('.topic');
                        console.log(cateData);
                        $('.topic_wrap').empty().html(cateData);

                        var pagingData = $('.paging_wrap').html(result).find('.paging_box');
                        $('.paging_wrap').html(pagingData);
                    },
                    error: function(xhr, status, error) {
                        console.error(error);
                    }
    ...
    <main>
        ...
        <c:forEach var="faqVO" items="${__LIST__}">
            <div class="topic">
                ...
                <div class="open">
                    <h2 class="question">
                        <span class="cate">[${faqVO.category}]</span>   ${faqVO.rownum}. ${faqVO.title}
                    </h2>
                    <div class="modify">

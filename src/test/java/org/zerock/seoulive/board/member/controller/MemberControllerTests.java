...
//	}	// end testInsertPassword
	...
	public void testUpdatePassword() {
		...
		System.out.println("pinter3");
//		this.mapper.updatePassword("id@gmail.com","abc1234");
		log.trace("\t testUpdatePassword() complete.");
		System.out.println();
	...
	public void testSelectEmail() {
		...
		tbl_memberVO result = this.mapper.selectEmail("testEmail12@naver.com");
...
//		log.trace(":\t result.get(0) : {}", result.get(0));
	...
	public void testDeleteEmail() {
		...
		System.out.println("pinter3");
		this.mapper.deleteEmail("testEmail13@naver.com");
		System.out.println("pointer4");
